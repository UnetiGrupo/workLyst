export function Quickactions ({ label, icon, variant = "secondary", onClick }) {
const variants = {

secondary: "bg-gray-50 border-gray-200 text-gray-700 hover:bg-gray-200",

primary: "bg-sky-500 border-[#63b3ed] text-white shadow-lg shadow-blue-100 hover:bg-sky-600",
};
