export function Taskitems ({ title, project, priority, date }) {
...
hover:bg-gray-50/50 transition-colors px-2 rounded-2xl">
      <div className="pr-4">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className={`${priorityStyles[priority]} text-[9px] px-2 py-0.5 rounded-lg font-black uppercase tracking-wider`}>
            {priority}
          </span>
        </div>
      </div>
